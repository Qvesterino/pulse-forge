/**
 * Validates the trained symbolic-melodic ONNX artifact with ONNX Runtime
 * (INTENT_ENGINE.md T2 v2): loads public/models/symbolic-melodic-v1.onnx,
 ...
 *
 * Run: node scripts/validate-symbolic-melodic.mjs
 */
...
const manifest = JSON.parse(readFileSync(path.join(modelsDir, "symbolic-melodic-v1.manifest.json"), "utf8"));
