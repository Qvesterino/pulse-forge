...
> Hotové: U1 (a1b1ba0), U2 (6119e98), U5 (ab3bdb5), P-časť (48cc665), U3 (7785d75a + c80849d), U4 (bc6c8060 + 7583f2f, sémantika schválená používateľom), meters pooling (3d846eff + 99e8a39). Zostáva voliteľné: export/import presetov.  
...
- [x] Exciter tone one-pole: koeficient z `sampleRate × (OS ? 4 : 1)`. Nález pri implementácii: pôvodný hardcoded 0.98 bol near-transparentný integrátor — Tone knob posúval level, nie tón. Oprava = funkčný 200 Hz tilt, rate/OS invariantný (testy 44.1/96k, OS on/off). Vektory bit-exact (Tone=0 short-circuit).
