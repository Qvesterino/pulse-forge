...
(() => {
  ...
  // src/audio-worklets/eq-processor.js
  var EQ_SMOOTH_TC = 3e-3;
  var BUTTER_Q = 0.7071067811865475;
  ...
  var EqProcessor = class extends AudioWorkletProcessor {
    ...
    static get parameterDescriptors() {
      return [
        { name: "hpFreq", defaultValue: 20, minValue: 20, maxValue: 1e3, automationRate: "k-rate" },
        { name: "lpFreq", defaultValue: 2e4, minValue: 2e3, maxValue: 2e4, automationRate: "k-rate" },
        ...
        { name: "highMidFreq", defaultValue: 2500, minValue: 500, maxValue: 8e3, automationRate: "k-rate" },
