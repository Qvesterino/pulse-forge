...
export const AI_BASELINE_CASES: readonly AiBaselineCase[] = [
  {
    ...
    style: "Driving",
    seed: "baseline-house-driving-v1",
  },
  {
    id: "house-minimal",
    genre: "house",
    ...
    style: "Minimal",
    seed: "baseline-house-minimal-v1",
  },
  {
    id: "techno-driving",
    genre: "techno",
    ...
    style: "Driving",
    seed: "baseline-techno-driving-v1",
  },
  {
    id: "techno-minimal",
    genre: "techno",
    ...
    style: "Minimal",
    seed: "baseline-techno-minimal-v1",
  },
  ...
  { id: "trap-rolling", genre: "trap", grooveId: "trap.rolling", style: "Rolling", seed: "baseline-trap-rolling-v1" },
  {
    ...
    style: "Drifting",
    seed: "baseline-ambient-drifting-v1",
  },
  {
    id: "ambient-glitch",
    genre: "ambient",
    ...
    style: "Glitch",
    seed: "baseline-ambient-glitch-v1",
  },
];
