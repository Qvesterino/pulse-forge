  ...
  it("round-trips a fully-populated document without dropping any field", () => {
    ...
    const fixture: ProjectDocument = {
      ...
      midi: {
        ...
        pitchBendRange: 12,
        programMap: [{ program: 4, presetId: "preset-7" }],
        bankSelect: true,
        aftertouchTarget: { kind: "trackGain", trackId: drum.id },
        aftertouchRange: 0.4,
      },
      tracks: [
        {
          ...
          pads: drum.pads.map((p, i) =>
            i === 0
              ? {
                  ...
                  sliceLoopStart: 0.2,
                  sliceLoopEnd: 0.8,
                  mod: { id: "mod-1", target: "pitch", depth: 0.5, rateHz: 3, wave: "sine" },
                }
              : p,
          ),
        },
        {
          ...
          velocityLayers: [{ id: "vl-1", sampleId: "sample-1", min: 0, max: 0.5 }],
        },
        {
          id: "group-1",
          kind: "group",
