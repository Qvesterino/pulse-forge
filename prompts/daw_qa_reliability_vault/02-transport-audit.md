# DAW Audit 02 — Transport

Audit the transport system for correctness and stability.
...
- seek
- loop
- repeated play/stop spam
- rapid seek
- loop-boundary changes
- tempo changes
- playhead synchronization
- project reload then playback

Check that:

- transport state has one authoritative source
- stop cancels future scheduled events
- seek invalidates stale scheduling
- playback does not duplicate
- repeated transport actions do not leak runtime objects
- UI playhead matches audible state
- transport remains valid after edits
