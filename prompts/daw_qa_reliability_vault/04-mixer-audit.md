...
Audit mixer behavior and routing.
...
- mute
- solo
- multiple solo states
- mute + solo combinations
- sends / returns
- master routing
- track routing
- meter correctness
...
Stress rapid changes during playback.

Look for:
- ghost audio after track deletion
- double routing
- stale sends
- incorrect mute/solo interaction
- gain mismatch
- state/UI divergence
