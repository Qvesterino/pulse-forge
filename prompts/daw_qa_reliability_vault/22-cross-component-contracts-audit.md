# DAW Audit 22 — Cross-Component Contracts

Audit contracts between major subsystems.

Inspect:
- UI ↔ project state
- project state ↔ audio engine
- audio engine ↔ plugin host
- track ↔ mixer
- timeline ↔ transport
...
Search for contract drift and duplicated definitions.
