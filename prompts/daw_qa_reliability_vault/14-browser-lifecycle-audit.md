# DAW Audit 14 — Browser Lifecycle

Audit behavior across browser lifecycle changes.
...
Verify:
- transport state remains valid
- UI resynchronizes
- autosave survives
- audio does not depend on animation frames
- workers do not become stale
