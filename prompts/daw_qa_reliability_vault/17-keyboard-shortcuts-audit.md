# DAW Audit 17 — Keyboard & Shortcuts

Audit keyboard interaction.
...
Test focus-sensitive behavior:
- text fields
- search fields
- numeric inputs
- modal dialogs

Ensure destructive shortcuts do not fire while typing into unrelated controls.
