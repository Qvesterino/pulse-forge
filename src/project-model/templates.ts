...
export const TEMPLATES: TemplateInfo[] = [
  ...
  },
  {
    id: "ukg",
    name: "UK Garage",
    description: "Swung 2-step drums, sub syncopation and organ stabs at 133 BPM.",
    bpm: 133,
    tags: ["2-step", "swing", "stabs"],
  },
  {
    id: "jersey",
    name: "Jersey Club",
    description: "The signature 3-3-2-3-3-2 kick bounce with squeak accents at 140 BPM.",
    bpm: 140,
    tags: ["bounce", "club"],
  },
  {
    id: "phonk",
    name: "Phonk",
    description: "Half-time snare, driven drum buss and a sliding 808 cowbell hook at 145 BPM.",
    bpm: 145,
    tags: ["808", "half-time", "driven"],
  },
  {
    id: "drill",
    name: "Drill",
    description: "Sparse kick, rolling hats and a sliding 808 at 142 BPM.",
    bpm: 142,
    tags: ["808", "slide", "dark"],
  },
  {
    id: "lofi-house",
    name: "Lo-Fi House",
    description: "Dusty swung 4-to-the-floor with tape-saturated drums and soft keys.",
    bpm: 118,
    tags: ["lo-fi", "swing", "dusty"],
  },
  {
    id: "reggaeton",
    name: "Reggaeton",
