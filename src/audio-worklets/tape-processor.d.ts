/**
 * Type stub for the plain-JS tape worklet processor (house pattern: see
 ...
 */
export declare function createTapeProcessor(): TapeProcessorInstance;

export interface TapeProcessorInstance {
