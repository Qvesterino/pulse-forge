...
class VowelProcessor extends AudioWorkletProcessor {
  constructor() {
    ...
    this.b0 = [1,1,1]; this.b1 = [0,0,0]; this.b2 = [0,0,0];
    this.a1 = [0,0,0]; this.a2 = [0,0,0];
    this.lastVowel = -1; this.lastRes = -1;
  }
  ...
  process(inputs, outputs, parameters) {
    ...
    if (vowel !== this.lastVowel || res !== this.lastRes) {
      ...
      for (let f = 0; f < 3; f++) {
        ...
        const a2 = 1 - alpha/A;
        // normalize by a0
        this.b0[f] = b0/a0; this.b1[f] = b1/a0; this.b2[f] = b2/a0;
        this.a1[f] = a1/a0; this.a2[f] = a2/a0;
      }
    }
    ...
    for (let i = 0; i < len; i++) {
      ...
      for (let f = 0; f < 3; f++) {
        ...
        this.x2[f][0] = this.x1[f][0]; this.x1[f][0] = wetL;
        this.y2[f][0] = this.y1[f][0]; this.y1[f][0] = yL;
        ...
        this.x2[f][1] = this.x1[f][1]; this.x1[f][1] = wetR;
        this.y2[f][1] = this.y1[f][1]; this.y1[f][1] = yR;
